...
let btnScoop1 = document.querySelector('#btn-scoop1');
let btnScoop2 = document.querySelector('#btn-scoop2');
let btnScoop3 = document.querySelector('#btn-scoop3');
let btnTopping1 = document.querySelector('#btn-topping1');
let btnTopping2 = document.querySelector('#btn-topping2');
